package co.gamep.sliced.services.std.display.logicalspace.primitives;

class SkyBox extends co.gamep.sliced.services.std.display.logicalspace.entities.Entity implements co.gamep.sliced.services.std.display.logicalspace.core.base.IRenderable {
