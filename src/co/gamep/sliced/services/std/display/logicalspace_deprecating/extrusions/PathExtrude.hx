...
class PathExtrude extends co.gamep.sliced.services.std.display.logicalspace.entities.Mesh {
	...
	public var path : co.gamep.sliced.services.std.display.logicalspace.paths.IPath;
