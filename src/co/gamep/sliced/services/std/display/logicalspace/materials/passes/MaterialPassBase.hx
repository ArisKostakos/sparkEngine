...
class MaterialPassBase {
	...
	public var animationRegisterCache : co.gamep.sliced.services.std.display.logicalspace.animators.data.AnimationRegisterCache;
	public var animationSet : co.gamep.sliced.services.std.display.logicalspace.animators.IAnimationSet;
