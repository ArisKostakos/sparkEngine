...
{	
	...
	override private function _addFile(p_name:String, p_url:String, p_fileFormat:AssetFormat, p_bytes:Int):Void
	{
		_manifest.add(p_name, p_url, p_bytes, p_fileFormat);
