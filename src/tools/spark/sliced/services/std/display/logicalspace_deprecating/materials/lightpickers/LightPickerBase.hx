package tools.spark.sliced.services.std.display.logicalspace.materials.lightpickers;

class LightPickerBase extends tools.spark.sliced.services.std.display.logicalspace.library.assets.NamedAssetBase implements tools.spark.sliced.services.std.display.logicalspace.library.assets.IAsset {
