package tools.spark.sliced.services.std.display.logicalspace.core.render;
...
class RendererBase {
	...
	public var renderableSorter : tools.spark.sliced.services.std.display.logicalspace.core.sort.IEntitySorter;
