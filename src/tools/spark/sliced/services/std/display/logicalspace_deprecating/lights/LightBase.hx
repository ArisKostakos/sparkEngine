package tools.spark.sliced.services.std.display.logicalspace.lights;

class LightBase extends tools.spark.sliced.services.std.display.logicalspace.entities.Entity {
	...
	public var shadowMapper : tools.spark.sliced.services.std.display.logicalspace.lights.shadowmaps.ShadowMapperBase;
