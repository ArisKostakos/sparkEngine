...
import org.gamepl.coreservices.services.std.logic.gde.interfaces.IGameClassValidator;
...
class GameClassParser implements IGameClassParser
{
	...
	private function _initEventPrefabToNameMap():Void
	{
		...
		_xmlEventPrefabToName[EEventPrefab.KEY_PRESSED_NUM_LOCK] = "KeyPressed_Numlock"; 
		_xmlEventPrefabToName[EEventPrefab.KEY_PRESSED_CLEAR] = "KeyPressed_Clear";
		_xmlEventPrefabToName[EEventPrefab.KEY_PRESSED_HELP] = "KeyPressed_Help";
		...
		_xmlEventPrefabToName[EEventPrefab.KEY_PRESSED_COLON] = "KeyPressed_Colon";
		_xmlEventPrefabToName[EEventPrefab.KEY_PRESSED_EQUALS] = "KeyPressed_Equals";
		_xmlEventPrefabToName[EEventPrefab.KEY_PRESSED_HYPHEN] = "KeyPressed_Hyphen";
		_xmlEventPrefabToName[EEventPrefab.KEY_PRESSED_SLASH] = "KeyPressed_Slash";
		_xmlEventPrefabToName[EEventPrefab.KEY_PRESSED_TILDE] = "KeyPressed_Tilde";
		_xmlEventPrefabToName[EEventPrefab.KEY_PRESSED_SQUARELEFT] = "KeyPressed_Squareleft";
		_xmlEventPrefabToName[EEventPrefab.KEY_PRESSED_SQUARERIGHT] = "KeyPressed_Squareright";
		_xmlEventPrefabToName[EEventPrefab.KEY_PRESSED_BACKSLASH] = "KeyPressed_Backslash";
		_xmlEventPrefabToName[EEventPrefab.KEY_PRESSED_APOSTROPHE] = "KeyPressed_Apostrophe";
		_xmlEventPrefabToName[EEventPrefab.KEY_PRESSED_TOPLEFT] = "KeyPressed_Topleft";
		_xmlEventPrefabToName[EEventPrefab.KEY_RELEASED_NUM_LOCK] = "KeyReleased_Numlock"; 
		_xmlEventPrefabToName[EEventPrefab.KEY_RELEASED_CLEAR] = "KeyReleased_Clear";
		_xmlEventPrefabToName[EEventPrefab.KEY_RELEASED_HELP] = "KeyReleased_Help";
		...
		_xmlEventPrefabToName[EEventPrefab.KEY_RELEASED_COLON] = "KeyReleased_Colon";
		_xmlEventPrefabToName[EEventPrefab.KEY_RELEASED_EQUALS] = "KeyReleased_Equals";
		_xmlEventPrefabToName[EEventPrefab.KEY_RELEASED_HYPHEN] = "KeyReleased_Hyphen";
		_xmlEventPrefabToName[EEventPrefab.KEY_RELEASED_SLASH] = "KeyReleased_Slash";
		_xmlEventPrefabToName[EEventPrefab.KEY_RELEASED_TILDE] = "KeyReleased_Tilde";
		_xmlEventPrefabToName[EEventPrefab.KEY_RELEASED_SQUARELEFT] = "KeyReleased_Squareleft";
		_xmlEventPrefabToName[EEventPrefab.KEY_RELEASED_SQUARERIGHT] = "KeyReleased_Squareright";
		_xmlEventPrefabToName[EEventPrefab.KEY_RELEASED_BACKSLASH] = "KeyReleased_Backslash";
		_xmlEventPrefabToName[EEventPrefab.KEY_RELEASED_APOSTROPHE] = "KeyReleased_Apostrophe";
		_xmlEventPrefabToName[EEventPrefab.KEY_RELEASED_TOPLEFT] = "KeyReleased_Topleft";
	}
	...
	private function _initEventNameToPrefabMap():Void
	{
		...
		_xmlEventNameToPrefab[_xmlEventPrefabToName[EEventPrefab.KEY_PRESSED_NUM_LOCK]] = EEventPrefab.KEY_PRESSED_NUM_LOCK; 
		_xmlEventNameToPrefab[_xmlEventPrefabToName[EEventPrefab.KEY_PRESSED_CLEAR]] = EEventPrefab.KEY_PRESSED_CLEAR;
		_xmlEventNameToPrefab[_xmlEventPrefabToName[EEventPrefab.KEY_PRESSED_HELP]] = EEventPrefab.KEY_PRESSED_HELP;
		...
		_xmlEventNameToPrefab[_xmlEventPrefabToName[EEventPrefab.KEY_PRESSED_COLON]] = EEventPrefab.KEY_PRESSED_COLON;
		_xmlEventNameToPrefab[_xmlEventPrefabToName[EEventPrefab.KEY_PRESSED_EQUALS]] = EEventPrefab.KEY_PRESSED_EQUALS;
		_xmlEventNameToPrefab[_xmlEventPrefabToName[EEventPrefab.KEY_PRESSED_HYPHEN]] = EEventPrefab.KEY_PRESSED_HYPHEN;
		_xmlEventNameToPrefab[_xmlEventPrefabToName[EEventPrefab.KEY_PRESSED_SLASH]] = EEventPrefab.KEY_PRESSED_SLASH;
		_xmlEventNameToPrefab[_xmlEventPrefabToName[EEventPrefab.KEY_PRESSED_TILDE]] = EEventPrefab.KEY_PRESSED_TILDE;
		_xmlEventNameToPrefab[_xmlEventPrefabToName[EEventPrefab.KEY_PRESSED_SQUARELEFT]] = EEventPrefab.KEY_PRESSED_SQUARELEFT;
		_xmlEventNameToPrefab[_xmlEventPrefabToName[EEventPrefab.KEY_PRESSED_SQUARERIGHT]] = EEventPrefab.KEY_PRESSED_SQUARERIGHT;
		_xmlEventNameToPrefab[_xmlEventPrefabToName[EEventPrefab.KEY_PRESSED_BACKSLASH]] = EEventPrefab.KEY_PRESSED_BACKSLASH;
		_xmlEventNameToPrefab[_xmlEventPrefabToName[EEventPrefab.KEY_PRESSED_APOSTROPHE]] = EEventPrefab.KEY_PRESSED_APOSTROPHE;
		_xmlEventNameToPrefab[_xmlEventPrefabToName[EEventPrefab.KEY_PRESSED_TOPLEFT]] = EEventPrefab.KEY_PRESSED_TOPLEFT;
		_xmlEventNameToPrefab[_xmlEventPrefabToName[EEventPrefab.KEY_RELEASED_NUM_LOCK]] = EEventPrefab.KEY_RELEASED_NUM_LOCK; 
		_xmlEventNameToPrefab[_xmlEventPrefabToName[EEventPrefab.KEY_RELEASED_CLEAR]] = EEventPrefab.KEY_RELEASED_CLEAR;
		_xmlEventNameToPrefab[_xmlEventPrefabToName[EEventPrefab.KEY_RELEASED_HELP]] = EEventPrefab.KEY_RELEASED_HELP;
		...
		_xmlEventNameToPrefab[_xmlEventPrefabToName[EEventPrefab.KEY_RELEASED_COLON]] = EEventPrefab.KEY_RELEASED_COLON;
		_xmlEventNameToPrefab[_xmlEventPrefabToName[EEventPrefab.KEY_RELEASED_EQUALS]] = EEventPrefab.KEY_RELEASED_EQUALS;
		_xmlEventNameToPrefab[_xmlEventPrefabToName[EEventPrefab.KEY_RELEASED_HYPHEN]] = EEventPrefab.KEY_RELEASED_HYPHEN;
		_xmlEventNameToPrefab[_xmlEventPrefabToName[EEventPrefab.KEY_RELEASED_SLASH]] = EEventPrefab.KEY_RELEASED_SLASH;
		_xmlEventNameToPrefab[_xmlEventPrefabToName[EEventPrefab.KEY_RELEASED_TILDE]] = EEventPrefab.KEY_RELEASED_TILDE;
		_xmlEventNameToPrefab[_xmlEventPrefabToName[EEventPrefab.KEY_RELEASED_SQUARELEFT]] = EEventPrefab.KEY_RELEASED_SQUARELEFT;
		_xmlEventNameToPrefab[_xmlEventPrefabToName[EEventPrefab.KEY_RELEASED_SQUARERIGHT]] = EEventPrefab.KEY_RELEASED_SQUARERIGHT;
		_xmlEventNameToPrefab[_xmlEventPrefabToName[EEventPrefab.KEY_RELEASED_BACKSLASH]] = EEventPrefab.KEY_RELEASED_BACKSLASH;
		_xmlEventNameToPrefab[_xmlEventPrefabToName[EEventPrefab.KEY_RELEASED_APOSTROPHE]] = EEventPrefab.KEY_RELEASED_APOSTROPHE;
		_xmlEventNameToPrefab[_xmlEventPrefabToName[EEventPrefab.KEY_RELEASED_TOPLEFT]] = EEventPrefab.KEY_RELEASED_TOPLEFT;
	}
	...
	inline private function _parseEmbeddedStringAsset(p_stringAssetUrl:String):Xml
	{
		try 
		{
			return Xml.parse(Assets.getText(p_stringAssetUrl));
		}
		catch (err:Dynamic) 
		{
