...
import org.gamepl.coreservices.services.std.logic.gde.haxe.LooseCheck;
import org.gamepl.coreservices.services.std.logic.gde.haxe.LooseCheck.Filter;
import org.gamepl.coreservices.services.std.logic.gde.haxe.LooseCheck.Rule;
import org.gamepl.coreservices.services.std.logic.gde.haxe.LooseCheck.Rule.RList;
import org.gamepl.coreservices.services.std.logic.gde.haxe.LooseCheck.Rule.RNode;
import org.gamepl.coreservices.services.std.logic.gde.haxe.LooseCheck.Rule.RChoice;
import org.gamepl.coreservices.services.std.logic.gde.haxe.LooseCheck.Rule.RData;
import org.gamepl.coreservices.services.std.logic.gde.haxe.LooseCheck.Rule.RMulti;
import org.gamepl.coreservices.services.std.logic.gde.haxe.LooseCheck.Rule.ROptional;
...
class GameClassValidator implements IGameClassValidator
{
	...
	inline private function _createEventNodeRule():Rule
	{
		var l_children:Rule = RData(FEnum([
								...
								_xmlEventPrefabToName[EEventPrefab.KEY_PRESSED_NUM_LOCK], 
								_xmlEventPrefabToName[EEventPrefab.KEY_PRESSED_CLEAR],
								_xmlEventPrefabToName[EEventPrefab.KEY_PRESSED_HELP],
								...
								_xmlEventPrefabToName[EEventPrefab.KEY_PRESSED_COLON],
								_xmlEventPrefabToName[EEventPrefab.KEY_PRESSED_EQUALS],
								_xmlEventPrefabToName[EEventPrefab.KEY_PRESSED_HYPHEN],
								_xmlEventPrefabToName[EEventPrefab.KEY_PRESSED_SLASH],
								_xmlEventPrefabToName[EEventPrefab.KEY_PRESSED_TILDE],
								_xmlEventPrefabToName[EEventPrefab.KEY_PRESSED_SQUARELEFT],
								_xmlEventPrefabToName[EEventPrefab.KEY_PRESSED_SQUARERIGHT],
								_xmlEventPrefabToName[EEventPrefab.KEY_PRESSED_BACKSLASH],
								_xmlEventPrefabToName[EEventPrefab.KEY_PRESSED_APOSTROPHE],
								_xmlEventPrefabToName[EEventPrefab.KEY_PRESSED_TOPLEFT],
								_xmlEventPrefabToName[EEventPrefab.KEY_RELEASED_NUM_LOCK], 
								_xmlEventPrefabToName[EEventPrefab.KEY_RELEASED_CLEAR],
								_xmlEventPrefabToName[EEventPrefab.KEY_RELEASED_HELP],
								...
								_xmlEventPrefabToName[EEventPrefab.KEY_RELEASED_COLON],
								_xmlEventPrefabToName[EEventPrefab.KEY_RELEASED_EQUALS],
								_xmlEventPrefabToName[EEventPrefab.KEY_RELEASED_HYPHEN],
								_xmlEventPrefabToName[EEventPrefab.KEY_RELEASED_SLASH],
								_xmlEventPrefabToName[EEventPrefab.KEY_RELEASED_TILDE],
								_xmlEventPrefabToName[EEventPrefab.KEY_RELEASED_SQUARELEFT],
								_xmlEventPrefabToName[EEventPrefab.KEY_RELEASED_SQUARERIGHT],
								_xmlEventPrefabToName[EEventPrefab.KEY_RELEASED_BACKSLASH],
								_xmlEventPrefabToName[EEventPrefab.KEY_RELEASED_APOSTROPHE],
								_xmlEventPrefabToName[EEventPrefab.KEY_RELEASED_TOPLEFT]
								])
							);
